			...
			if (rs1.next() && rs2.next()) {
				...
				if (balance2 >= amount) {
					...
					if (a != 0 && b != 0) {
						...
						response.getWriter().print("" + "<html>" + "<body bgcolor='cyan'>" + "<center>"
								+ "<h1>Transaction Successfull</h1><br>" + "<form action='main.jsp'>"
				...
				response.getWriter()
						.print("" + "<html>" + "<body bgcolor='cyan'>" + "<center>" + "<h1>No user found!</h1><br>"

...
import org.infinite.persistence.StudentDBOperations;
...
public class HibernateTest {
	public static void main(String[] args) {
		...
		Student student1 = new Student("Sam", "Kolaparthi", "MCA final", "MCA/07/1902", 27);
		Student student2 = new Student("Sunil", "Yash", "MCA final", "MCA/07/2023", 32);
